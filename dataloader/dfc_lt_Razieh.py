...
def dataloader(filepath):
 ...
 # get image file list
 all_left_img = glob.glob(filepath + '*_LEFT_RGB.tif')
 #print(all_left_img)
 nimage_ids = len(all_left_img)
 #print('Number of left img = ', nimage_ids)

 for im in all_left_img:
     #print(im[0:-13])
     all_right_img.append(im[0:-13] + '_RIGHT_RGB.tif')
     all_left_disp.append(im[0:-13] + '_LEFT_DSP.tif')

 #all_right_img = glob.glob(filepath + '*_RIGHT_RGB.tif')
 #print(all_right_img)
 #nimage_ids = len(all_right_img)
 #print('Number of right img = ', nimage_ids)

 #all_left_disp = glob.glob(filepath + '*_LEFT_DSP.tif')
 #print(all_left_disp)
 #nimage_ids = len(all_left_disp)
 #print('Number of left disp img = ', nimage_ids)
